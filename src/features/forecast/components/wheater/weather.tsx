...
export const Weather: FC<Props> = ({ forecastData, city }) => {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-full w-full">
            ...
            <h2 className="text-6xl font-bold">{forecastData.main.temp.toFixed(1)}°C</h2>
            <h3 className="text-2xl font-bold">Feels like: {forecastData.main.feels_like.toFixed(1)}°C</h3>
        </div>
    )
}